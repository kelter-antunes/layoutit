...
function handleAccordionIds() {
    ...
    var elmId = 'accordion-' + random;
    var accordionElementId;
    elm.attr('id', elmId);

    elm.find('.accordion-group').each(function(current, element) {
        accordionElementId = 'accordion-element-' + randomNumber();

        $(element).find('.accordion-toggle').each(function(toggleCurrent, toggleElement) {
            $(toggleElement).attr('data-parent', '#' + elmId);
            $(toggleElement).attr('href', '#' + accordionElementId);
        });

        $(element).find('.accordion-body').each(function(bodyCurrent, bodyElement) {
...
function downloadLayoutSrc() {
    ...
    downloadContent.find('.lyrow .lyrow .lyrow .lyrow .lyrow .removeClean').each(function() {
        cleanHtml(this)
    });
    downloadContent.find('.lyrow .lyrow .lyrow .lyrow .removeClean').each(function() {
        cleanHtml(this)
    });
